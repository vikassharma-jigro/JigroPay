...
class _InsuranceProviderScreenState extends State<InsuranceProviderScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      rechargeController.fetchOperatorsByType(context: context, type: "insurance");
    });
  }
                ...
                if (filtered.isEmpty) {
                  return Center(
                    child: Padding(
                      ...
                      child: Text("No insurance providers found.", style: TextStyle(color: greyColor, fontFamily: FontFamily.plusJakartaSansRegular)),
                    ),
                  );
                }
                                ...
                                children: [
                                  if (iconUrl != null && iconUrl.isNotEmpty)
                                    Image.network(
                                      ...
                                      height: 30,
                                      width: 30,
                                      errorBuilder: (context, error, stackTrace) => SvgPicture.asset(AppImages.insuranceImage, height: 30, width: 30),
                                    )
                                  else
                                    SvgPicture.asset(AppImages.insuranceImage, height: 30, width: 30),
                                  SizedBox(width: 20),
                                  Expanded(
                                    child: text(
                                      name,
