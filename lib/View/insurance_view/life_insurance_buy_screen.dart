            ...
            children: [
                  ...
                  child: Column(
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          text("TATA AIA Sampoorna Raksha\nPromise",
                      ...
                      Container(
                        ...
                        child: text("Premium from second year onwards will be ₹1,124",
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: text("No GST amount will be collected on Life Insurance Premiums",
                          textColor:lightGreenColor,fontSize: 14,
                          maxLine: 2,
                          fontFamily: FontFamily.plusJakartaSansRegular,
                          fontWeight: FontWeight.w400),
                    ),
