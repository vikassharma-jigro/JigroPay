...
import '../../../main.dart';
import 'bike_review_details_screen.dart';

class BikeViewQuotesScreen extends StatefulWidget {
  const BikeViewQuotesScreen({super.key});

  @override
  State<BikeViewQuotesScreen> createState() => _BikeViewQuotesScreenState();
}

class _BikeViewQuotesScreenState extends State<BikeViewQuotesScreen> {
                ...
                child: CommonButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => BikeReviewDetailsScreen(),
                      ),
                    );
                  },
                ),
