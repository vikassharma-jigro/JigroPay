...
class HealthPlanInsuranceScreen extends StatefulWidget {
  ...
  @override
  State<HealthPlanInsuranceScreen> createState() =>
      _HealthPlanInsuranceScreenState();
}
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10),
                    text(
                      "Exclusive no room rent cap on any type",
                      textAlign: TextAlign.center,
                      isCentered: true,
                      textColor: blackColor,
                      fontSize: 13,
                ...
                child: CommonButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => HealthInsuranceFromScreen(),
                      ),
                    );
                  },
                ),
