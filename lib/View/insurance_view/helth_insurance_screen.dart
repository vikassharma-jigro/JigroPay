        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        text("A healthcare plan like no other",
                            textAlign: TextAlign.center,
                            isCentered: true,
                    ...
                    text("Curated group health insurance",
                        textAlign: TextAlign.center,
                        isCentered: true,
                        textColor:greyColor,fontSize: 16,
                        fontFamily: FontFamily.plusJakartaSansRegular,
              ...
              _optionButton("Only me", Icons.person, selectedMember == "Only me", () {
                setState(() => selectedMember = "Only me");
              }),
              _optionButton("Me & my spouse", Icons.person, selectedMember == "Me & my spouse", () {
                setState(() => selectedMember = "Me & my spouse");
              }),
              _optionButton("Me, my spouse & 1 child", Icons.person, selectedMember == "Me, my spouse & 1 child", () {
                setState(() => selectedMember = "Me, my spouse & 1 child");
              }),
              _optionButton("Me, my spouse & 2 children", Icons.person, selectedMember == "Me, my spouse & 2 children", () {
              ...
              SizedBox(
                ...
                child: CommonButton(
                    ...
                    onPressed: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => HealthChildInsuranceScreen(),));
                    }
