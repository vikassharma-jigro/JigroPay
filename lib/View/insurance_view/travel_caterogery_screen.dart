          ...
          children: [
            ...
            SizedBox(
              ...
              child: CommonButton(
                  ...
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => TravelPlanScreen(),));
                  }
              ),
            ),
          ],
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          children: [
            ...
            text("Choose the number of travellers for your trip",
                textAlign: TextAlign.center,
                isCentered: true,
