...
class LifeCongratulationsScreen extends StatefulWidget {
  ...
  @override
  State<LifeCongratulationsScreen> createState() =>
      _LifeCongratulationsScreenState();
}
...
class _LifeCongratulationsScreenState extends State<LifeCongratulationsScreen> {
  ...
  final List<String> occupations = ["Student", "Employee", "Business", "Other"];
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              text(
                "Congratulations! Your recommended cover is here",
                textAlign: TextAlign.center,
                isCentered: true,
