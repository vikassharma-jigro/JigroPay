...
class _SearchBusScreenState extends State<SearchBusScreen>{
  ...
  List<Map<String, dynamic>> trainData = [
    {"name": "RSRTC", "dis": "Ganganagar Sado Road Trans.", "amount": "₹6,645","timeFrom": "36 SEATER 2X2 NONAC Available","offer":"50% off for Female Travellers"},
    {"name": "Suryavanshi Travels", "dis": "AC Seater (2+1)", "amount": "₹3,335","timeFrom":"1 Single Berth (LB-1)","offer":""},
    {"name": "Suryavanshi Travels", "dis": "AC Sleeper (2+1)", "amount": "₹3,645","timeFrom":"1 Single Berth (LB-1)","offer":""},
    {"name": "Pooja Yaduvanshi Travels", "dis": "AC Sleeper (2+1)", "amount": "₹3,645","timeFrom":"1 Single Berth (LB-1)","offer":""},
    ];
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: isSelectedColor?lightBlueColor:lightWhite1Color,

                          ),
                            child: text(allDate[index]["name"],
                              textAlign: TextAlign.center,
                              isCentered: true,
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Padding(
                    ...
                    child: InkWell(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => BusPointScreen(),));
                      },
                      child: Card(
                        color: white,
                        child: Padding(
