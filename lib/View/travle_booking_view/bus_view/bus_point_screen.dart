...
class _BusPointScreenState extends State<BusPointScreen>{
  ...
  List<Map<String, dynamic>> allDate = [
    {"name": "Gajraj Travels Kamla bhawan Opp. Hotel Neelam jaipur","time":"18:15"},
      ...
      bottomNavigationBar:  Padding(
        ...
        child: SizedBox(
          ...
          child: CommonButton(
              ...
              onPressed: (){
                Navigator.push(context,MaterialPageRoute(builder: (context) => BusPassengerScreen(),));
              }
          ),
        ),
      ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  InkWell(
                    ...
                    child: text("Boarding Point",
                        textColor:isSelectedPoint!=true?greyColor:purpleGradientColor,fontSize: 18,
                        fontFamily: FontFamily.plusJakartaSansBold,
                        fontWeight: FontWeight.w600),
                  ),
              ...
              SizedBox(height: 20,),
              text(isSelectedPoint==true?"Select your Boarding Point":"Select your Dropping Point",
                  textColor:blackColor,fontSize: 18,
                  fontFamily: FontFamily.plusJakartaSansBold,
                  fontWeight: FontWeight.w600),
              isSelectedPoint==true?ListView.builder(
                shrinkWrap: true,
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Radio<int>(
                              ...
                              activeColor: blue1Color, // optional custom color
                              onChanged: (value) {
                                setState(() {
                                  isSelected = value!;
                                });
                            ...
                            Expanded(
                              child: text(
                                allDate[index]["name"],
                                maxLine: 2,
                                textColor: isSelectedColor ? blue1Color : blackColor,
                                fontSize: 14,
                  ...
                  return Padding(
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(15),
                          color: isSelectedColor ? yellowColor : lightWhite1Color,
                        ),
                        child: Row(
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
