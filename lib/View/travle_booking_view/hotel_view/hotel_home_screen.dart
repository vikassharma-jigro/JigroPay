            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Center(
                      child: text("EaseMyTrip",
                          textAlign: TextAlign.center,
                          isCentered: true,
                          textColor:blue1Color,fontSize: 24,
                          fontFamily: FontFamily.plusJakartaSansBold,
                    ...
                    text(".com",
                        textAlign: TextAlign.center,
                        isCentered: true,
                        textColor:purpleGradientColor,fontSize: 24,
                        fontFamily: FontFamily.plusJakartaSansBold,
                        fontWeight: FontWeight.w600),
                  ],
                ),
                Center(
                  child: text("SAME HOTEL, CHEAPEST PRICE, GUARANTEED!",
                      textAlign: TextAlign.center,
                      isCentered: true,
                ...
                InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => SearchHotelsScreen(),));
                  },
                  child: Container(
                    ...
                    Column(
                      children: [
                        Container(
                          ...
                          child: text("Spree",
                              textColor: red1Color,fontFamily: FontFamily.plusJakartaSansBold,
                              fontSize: 14,fontWeight: FontWeight.w400,
                              maxLine: 3
                          ),
                        ),
                        text("20% OFF",
                            textColor: lightGreenColor,fontFamily: FontFamily.plusJakartaSansBold,
                            fontSize: 14,fontWeight: FontWeight.w400,
                            maxLine: 3
                        ),
                      ],
                    ...
                    Column(
                      children: [
                        Container(
                          ...
                          child: text("The Fern",
                              textColor: pinkColor,fontFamily: FontFamily.plusJakartaSansBold,
                              fontSize: 13,fontWeight: FontWeight.w400,
                              maxLine: 3
                          ),
                        ),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            text("Find hotels for different destinations",
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            text("Massive Savings",
                                textColor: blackColor,fontFamily: FontFamily.plusJakartaSansBold,
                                fontSize: 13,fontWeight: FontWeight.w400,
                                maxLine: 3
                            ),
                            text("Enjoy hotel bookings with best offers",
                                textColor: greyColor,fontFamily: FontFamily.plusJakartaSansRegular,
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            text("Good ratings based on Trip Advisor",
                                textColor: greyColor,fontFamily: FontFamily.plusJakartaSansRegular,
                                fontSize: 10,fontWeight: FontWeight.w400,
                                maxLine: 3
                            ),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            text("Get excellent hotels/resorts",
                                textColor: greyColor,fontFamily: FontFamily.plusJakartaSansRegular,
                                fontSize: 10,fontWeight: FontWeight.w400,
                                maxLine: 3
                            ),
