                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                child: text("New Delhi • Hanuman Road • Janpath • Connaught Place",
                                    textColor:blackColor,fontSize: 14,
                                    fontFamily: FontFamily.plusJakartaSansRegular,
                                    fontWeight: FontWeight.w500,maxLine: 2
                                ),
                              )
                            ],
                          ),
                              ...
                              Container(
                                  ...
                                  child:Padding(
                                    ...
                                    child: text("4.2",
                                        ...
                                        fontFamily: FontFamily.plusJakartaSansBold,
                                        fontWeight: FontWeight.w600,maxLine: 2
                                    ),
                                  ) ),
                              Column(
                                children: [
                          ...
                          SizedBox(height: 10,),
                          text("Couple friendly Free wifi",
                              textColor:greyColor,fontSize: 14,
                              fontFamily: FontFamily.plusJakartaSansRegular,
                              fontWeight: FontWeight.w400,maxLine: 2
                          ),
                          ...
                          Container(
                            ...
                            child:  Column(
                              ...
                              children: [
                                ...
                                text("• 10% Discount on Food & Soft Beverages",
                                    textColor:blackColor,fontSize: 14,
                                    fontFamily: FontFamily.plusJakartaSansBold,
                                    fontWeight: FontWeight.w400,maxLine: 2
                                ),
                                text("• Flat ₹500 Cashback on Bookings above ₹5000",
                                    textColor:blackColor,fontSize: 14,
                                    fontFamily: FontFamily.plusJakartaSansBold,
                                    fontWeight: FontWeight.w400,maxLine: 2
                                ),
