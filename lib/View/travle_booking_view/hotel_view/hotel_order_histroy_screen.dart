...
class HotelOrderHistoryScreen extends StatefulWidget{
  ...
  State<HotelOrderHistoryScreen> createState() => _HotelOrderHistoryScreenState();
}
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Row(
                  children: [
                    text("Complete payment within 14:56 minutes",
                        textColor: red1Color,
                        fontSize: 14,
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          //SizedBox(width: 10,),
                          SvgPicture.asset(AppImages.creditCardIcon,height: 20,),
                          SizedBox(width: 10,),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          //SizedBox(width: 10,),
                          SvgPicture.asset(AppImages.netBankingImage,height: 30,),
                          SizedBox(width: 10,),
                          text("Net Banking",
                              textColor: blackColor,
                              fontSize: 16,
