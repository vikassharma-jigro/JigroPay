                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 10,),
                          text("JP - Jaipur Jn (19 Oct, 06:15)",
                              textAlign: TextAlign.center,
                              isCentered: true,
                              textColor:blackColor,fontSize: 14,
                              fontFamily: FontFamily.plusJakartaSansRegular,
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          text("Additional Preferences (Optional)",
                              textAlign: TextAlign.center,
                              isCentered: true,
                              textColor:blackColor,fontSize: 18,
                              fontFamily: FontFamily.plusJakartaSansBold,
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          text("Add GST for Tax Benefits (Optional)",
                              textAlign: TextAlign.center,
                              isCentered: true,
                              textColor:blackColor,fontSize: 18,
                              fontFamily: FontFamily.plusJakartaSansBold,
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 10,),
                          Expanded(
                            child: text("Do you want to take Travel Insurance (₹0.45/person)?",
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 10,),
                          Expanded(
                            child: text("Consider for auto upgradation",
                                textColor: greyColor,fontFamily: FontFamily.plusJakartaSansRegular,
                                fontSize: 14,fontWeight: FontWeight.w400,
                                maxLine: 3
                            ),
                      ...
                      text("By proceeding, you agree to our Cancellation & Refund Policy, Privacy Policy and Terms of use.",
                          textAlign: TextAlign.center,
                          isCentered: true,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      text("Fare may change due to dynamic pricing by the railways",
                          textAlign: TextAlign.center,
                          isCentered: true,
                          textColor:blackColor,fontSize: 13,
                          fontFamily: FontFamily.plusJakartaSansRegular,
