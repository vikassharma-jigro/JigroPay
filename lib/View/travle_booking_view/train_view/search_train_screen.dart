...
class _SearchTrainScreenState extends State<SearchTrainScreen> {
  ...
  List<Map<String, dynamic>> trainData = [
    {
      "name": "12963 - Udaipur Express",
      "timeTo": "22:35",
      "amount": "₹6,645",
      "timeFrom": "23:35",
    },
    {
      "name": "12991 - Kavi Guru Exp",
      "timeTo": "18:40",
      "amount": "₹3,335",
      "timeFrom": "20:33",
    },
    {
      "name": "22461 - JP UDZ Exp",
      "timeTo": "08:25",
      "amount": "₹3,645",
      "timeFrom": "10:33",
    },
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => TrainBookingPayScreen(),
                          ),
                        );
                      },
                      child: Card(
