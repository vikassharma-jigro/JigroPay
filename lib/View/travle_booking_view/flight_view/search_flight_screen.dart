...
class _SearchFlightScreenState extends State<SearchFlightScreen>{
  ...
  List<Map<String, dynamic>> trainData = [
    {"name": "IndiGo 6E 6262", "timeTo": "22:35", "amount": "₹6,645","timeFrom": "23:35"},
    {"name": "Air India Express IX 1191", "timeTo": "18:40", "amount": "₹3,335","timeFrom":"20:33"},
    {"name": "IndiGo 6E 2165", "timeTo": "08:25", "amount": "₹3,645","timeFrom":"10:33"},
    {"name": "Air India AI 9743, 840", "timeTo": "22:00", "amount": "₹3,645","timeFrom":"23:33"},
    {"name": "Air India AI 9743, 840", "timeTo": "24:00", "amount": "₹3,645","timeFrom":"25:33"},
    {"name": "IndiGo 6E 6262", "timeTo": "08:25", "amount": "₹3,645","timeFrom":"10:33"},
  ];
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Padding(
                    ...
                    child: InkWell(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => FlightTravelFormScreen(),));
                      },
                      child: Card(
                        color: white,
                        child: Padding(
