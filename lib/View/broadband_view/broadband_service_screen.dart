...
class BroadbandServiceScreen extends StatefulWidget {
  const BroadbandServiceScreen({super.key});

  @override
  State<BroadbandServiceScreen> createState() => _BroadbandServiceScreenState();
}

class _BroadbandServiceScreenState extends State<BroadbandServiceScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      rechargeController.fetchOperatorsByType(context: context, type: "broadband");
    });
  }
                ...
                if (filtered.isEmpty) {
                  return Center(
                    child: Padding(
                      ...
                      child: Text("No broadband providers found.", style: TextStyle(color: greyColor, fontFamily: FontFamily.plusJakartaSansRegular)),
                    ),
                  );
                }
                                ...
                                children: [
                                  if (iconUrl != null && iconUrl.isNotEmpty)
                                    Image.network(
                                      ...
                                      height: 30,
                                      width: 30,
                                      errorBuilder: (context, error, stackTrace) => Image.asset(AppImages.boradImage, height: 30, width: 30),
                                    )
                                  else
                                    Image.asset(AppImages.boradImage, height: 30, width: 30),
                                  SizedBox(width: 20),
                                  Expanded(
                                    child: text(
                                      name,
