...
class _HomeScreenState extends State<HomeScreen> {
  Map<int, PageController> pageControllers = {}; // हर index के लिए PageController स्टोर करें
                 ...
                 SizedBox(
                   ...
                   child: Stack(
                     children: [
                       PageView.builder(
                         itemCount: 5,
                         controller: PageController(viewportFraction: 1.0), // अलग PageController
                       ...
                       Row(
                         ...
                         children: [
                          GestureDetector(
                            ...
                            child: Column(
                              children: [
                                Container(
                                  ...
                                  child: Image.asset(AppImages.user1Icon,height: 30,),
                                ),
                                SizedBox(height: 5,),
                                text(
                                  "To Mobile\nNumber",
                             ...
                             child: Column(
                               children: [
                                 Container(
                                   ...
                                   child: Image.asset(AppImages.bankIcon,height: 30,),
                                 ),
                                 SizedBox(height: 5,),
                                 text(
                                   "To Bank/\n UPI ID",
                           ...
                           GestureDetector(
                             onTap: (){
                               Navigator.push(context, MaterialPageRoute(builder: (context) => SelfAccountScreen(),));
                             },
                             child: Column(
                               children: [
                                 Container(
                                   ...
                                   child: Image.asset(AppImages.selfAcIcon,height: 30,),
                                 ),
                                 SizedBox(height: 5,),
                                 text(
                                   "To Self \nAccount",
                             ...
                             child: Column(
                               children: [
                                 Container(
                                   ...
                                   child: Image.asset(AppImages.checkBalIcon,height: 30,),
                                 ),
                                 SizedBox(height: 5,),
                                 text(
                                   "Check\nBalance",
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            ...
                            child: Column(
                              children: [
                                Image.asset(AppImages.electricityIcon,height: 30,),
                                SizedBox(height: 5,),
                                Center(
                                  child: text(
                                    "Electricity",
                       ...
                       Row(
                         ...
                         children: [
                           InkWell(
                             ...
                             child: Column(
                               children: [
                                 Image.asset(AppImages.rentpaymentIcon,height: 30,),
                                 SizedBox(height: 5,),
                                 Center(
                                   child: text(
                                     "Rent Payment",
                           ...
                           InkWell(
                             ...
                             child: Column(
                               children: [
                                 Image.asset(AppImages.loanRepaymentIcon,height: 30,),
                                 SizedBox(height: 5,),
                                 Center(
                                   child: text(
                                     "Loan\nRepayment",
                     ...
                     children: [
                       ...
                       Row(
                         ...
                         children: [
                           GestureDetector(
                             onTap: (){
                               Navigator.push(context, MaterialPageRoute(builder: (context) => BikeInsuranceScreen(),));
                             },
                             child: Column(
                               children: [
                           ...
                           InkWell(
                             onTap: (){
                               Navigator.push(context, MaterialPageRoute(builder:(context) => CarInsuranceScreen(),));
                             },
                             child: Column(
                               children: [
                           ...
                           InkWell(
                             onTap: (){
                               Navigator.push(context, MaterialPageRoute(builder: (context) => AccidentInsuranceScreen(),));
                             },
                             child: Column(
                               children: [
                       ...
                       Row(
                         ...
                         children: [
                           InkWell(
                             onTap: (){
                               Navigator.push(context, MaterialPageRoute(builder: (context) => TermLifeInsuranceScreen(),));
                             },
                             child: Column(
                               children: [
                           ...
                           InkWell(
                             onTap: (){
                               Navigator.push(context, MaterialPageRoute(builder: (context) => TravelInsuranceCountriesScreen(),));
                             },
                             child: Column(
                               children: [
                                 Image.asset(AppImages.traveLinsuranceIcon,height: 30,),
                                 SizedBox(height: 5,),
                                 Center(
                                   child: text(
                                     "Travel\nInsurance",
                           ...
                           InkWell(
                             ...
                             child: Column(
                               children: [
                                 Image.asset(AppImages.insuranceRenewalIcon,height: 30,),
                                 SizedBox(height: 5,),
                                 Center(
                                   child: text(
                                     "Insurance\nRenewal",
                     ...
                     children: [
                       ...
                       Row(
                         ...
                         children: [
                           InkWell(
                             onTap: (){
                               Navigator.push(context, MaterialPageRoute(builder: (context) => FlightBookingScreen(),));
                             },
                             child: Column(
                               children: [
                           ...
                           InkWell(
                             onTap: (){
                               Navigator.push(context, MaterialPageRoute(builder: (context) => BusBookingPointScreen() ,));
                             },
                             child: Column(
                               children: [
                           ...
                           InkWell(
                             onTap: (){
                               Navigator.push(context, MaterialPageRoute(builder: (context) => TrainBookingScreen(),));
                             },
                             child: Column(
                               children: [
