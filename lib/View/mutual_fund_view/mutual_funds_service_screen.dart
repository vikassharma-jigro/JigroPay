...
class MutualFundsServiceScreen extends StatefulWidget {
  ...
  @override
  State<MutualFundsServiceScreen> createState() => _MutualFundsServiceScreenState();
}
                ...
                itemBuilder: (context, index) {
                  return Padding(
                    ...
                    child:  GestureDetector(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => MutualRegistrationScreen(serviceNo: options[index],),));
                      },
                      child: Container(
