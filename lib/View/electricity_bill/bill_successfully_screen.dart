...
class BillSuccessfullyScreen extends StatefulWidget {
  final String? bankName;
  const BillSuccessfullyScreen({super.key,this.bankName});

  @override
  State<BillSuccessfullyScreen> createState() => _BillSuccessfullyScreenState();
}


class _BillSuccessfullyScreenState extends State<BillSuccessfullyScreen> {
