...
class _ScanPhotoScreenState extends State<ScanPhotoScreen>with ImagePickerMixin<ScanPhotoScreen> {
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  SizedBox(width: 20,),
                  text("Remove your eye glass(if have any).",textColor: greyColor,
                      fontSize: 13,
              ...
              Row(
                children: [
                  ...
                  SizedBox(width: 20,),
                  text("Place your face in photo frame.",textColor: greyColor,
                      fontSize: 13,
                      fontWeight: FontWeight.w400,
                      fontFamily: FontFamily.plusJakartaSansMedium),
                ],
              ...
              Row(
                children: [
                  ...
                  SizedBox(width: 20,),
                  text("Do not shake your face when capturing photo.",textColor: greyColor,
                      fontSize: 13,
                      fontWeight: FontWeight.w400,
                      fontFamily: FontFamily.plusJakartaSansMedium),
                ],
              ...
              Row(
                children: [
                  ...
                  SizedBox(width: 20,),
                  text("Blink your eyes several times to capture photo.",textColor: greyColor,
                      fontSize: 13,
                      fontWeight: FontWeight.w400,
                      fontFamily: FontFamily.plusJakartaSansMedium),
                ],
              ...
              SizedBox(
                ...
                child: CommonButton(
                    ...
                    onPressed: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => UseAppScreen(),));
                    }
                    ),
              ),
            ],
