...
import 'package:jigrotech/View/auth_view/championScreen.dart';
...
class OtpScreen extends StatefulWidget {
  ...
  final String? email;
  const OtpScreen({super.key, this.mobileNumber, this.email});
        ...
        appBar: AppBar(
          ...
          title: Row(
            children: [
              ...
              Expanded(child: Center(child: Image.asset(AppImages.jigroImage, height: 40))),
            ],
          ),
        ),
                    ...
                    return authController.isLoading.value
                        ...
                        : CommonButton(
                            ...
                            onPressed: () {
                              ...
                              String otp = numberController.text.trim();
                                  ...
                                  onSuccess: () {
                                    if (widget.email != null && widget.email!.isNotEmpty) {
                                      Navigator.pushAndRemoveUntil(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => VerifiedChampionScreen(
