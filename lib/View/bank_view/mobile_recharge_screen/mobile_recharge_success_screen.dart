...
class MobileRechargeSuccessScreen extends StatefulWidget {
  ...
  @override
  State<MobileRechargeSuccessScreen> createState() =>
      _MobileRechargeSuccessScreenState();
}

class _MobileRechargeSuccessScreenState
    extends State<MobileRechargeSuccessScreen> {
  @override
  void initState() {
    super.initState();
  }
