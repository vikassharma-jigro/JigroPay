...
class RechargePlanScreen extends StatefulWidget {
  ...
  final String? photo;
  final String? number;
  const RechargePlanScreen({super.key,this.mobileRechargeNumber,this.photo,this.number});
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: text("5G Upgraded Pack",
                                textAlign: TextAlign.center,
                                isCentered: true,
                                textColor:lightGreenColor,fontSize: 12,
                                fontFamily: FontFamily.plusJakartaSansRegular,
