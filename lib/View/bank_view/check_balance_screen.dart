          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.push(context,MaterialPageRoute(builder: (context) => UpiPinScreen(bankName: "Rajasthan Gramin Bank-8093",),));
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Row(
                              children: [
                                SvgPicture.asset(AppImages.upiLiteImage,height: 50,),
                                SizedBox(width: 23,),
                                text("UPI Lite",
                                    textAlign: TextAlign.center,
                                    isCentered: true,
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Row(
                              children: [
                                SvgPicture.asset(AppImages.walletImage,height: 50,),
                                SizedBox(width: 23,),
                                text("PhonePe Wallet",
                                    textAlign: TextAlign.center,
                                    isCentered: true,
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    text("to check balance for RuPay card,\nbank accounts & more.",
