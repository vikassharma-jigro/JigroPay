...
class AddBankAccountListScreen extends StatefulWidget {
  ...
  @override
  State<AddBankAccountListScreen> createState() =>
      _AddBankAccountListScreenState();
}
...
class _AddBankAccountListScreenState extends State<AddBankAccountListScreen> {
  ...
  List<Map<String, dynamic>> allData = [
    {
      "image": SvgPicture.asset(AppImages.rajImage, height: 50),
      "bankName": "SBI",
    },
    {
      "image": SvgPicture.asset(AppImages.rajImage, height: 50),
  ...
  List<Map<String, dynamic>> allBankData = [
    {
      "image": SvgPicture.asset(AppImages.bankImage, height: 50),
      "bankName": "The Rayat Sevak Co-Op Bank",
    },
    {
      "image": SvgPicture.asset(AppImages.bankImage, height: 50),
      "bankName": "PNB",
