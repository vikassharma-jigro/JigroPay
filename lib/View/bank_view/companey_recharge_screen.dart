...
class CompanyRechargeScreen extends StatefulWidget {
  ...
  final String? photo;
  final String? number;
  const CompanyRechargeScreen({super.key,this.mobileRechargeNumber,this.photo,this.number});
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  CircleAvatar(
                      backgroundImage: MemoryImage(base64Decode(widget.photo??""))),

                  SizedBox(width: 20,),
                  text(widget.mobileRechargeNumber??"",
                      textAlign: TextAlign.center,
                      isCentered: true,
