...
class _KycDocumentScreenState extends State<KycDocumentScreen>with ImagePickerMixin<KycDocumentScreen> {
  ...
  Widget build(BuildContext context) {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: text("Scan the front side of NID card with camera",
              ...
              Stack(
                ...
                children: [
                  _pickedImage == null? Image.asset(AppImages.documentIcon,fit: BoxFit.cover,):
        ClipRRect(
    ...
    fit: BoxFit.cover,
              ...
              Center(
                child: text("Scan the back side of NID card with camera",
                    textColor:greyColor,fontSize: 12,
                    fontFamily: FontFamily.plusJakartaSansMedium,
                    fontWeight: FontWeight.w400),
              ),
              ...
              Stack(
                clipBehavior: Clip.none,
                children: [
                  _pickedBackImage == null?Image.asset(AppImages.documentIcon,fit: BoxFit.cover,):
                  ClipRRect(
                    borderRadius: BorderRadius.circular(10),
                    child: Image.file(
