    ...
    return GradientAppScaffold(
      appBar: AppBar(
        ...
        title:   Row(
          children: [
            ...
            Expanded(
              child: text(widget.cableServiceName??"",
      ...
      bottomNavigationBar: Padding(
        ...
        child: Column(
          ...
          children: [
            Center(
              child: text("We'll save your details for future payments. You can always go to Bills to pay your upcoming dues.",
              isCentered: true,
              fontSize: 14,
            ...
            SizedBox(
              ...
              child: CommonButton(
                  ...
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => CableAmountScreen(),));
                  }
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              text("Enter your Card No to retrieve your account details.",
