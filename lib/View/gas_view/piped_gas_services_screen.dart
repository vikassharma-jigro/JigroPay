...
class _PipedGasServicesScreenState extends State<PipedGasServicesScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      rechargeController.fetchOperatorsByType(context: context, type: "lpg");
    });
  }
                ...
                if (filtered.isEmpty) {
                  return Center(
                    child: Padding(
                      ...
                      child: Text("No providers found.", style: TextStyle(color: greyColor, fontFamily: FontFamily.plusJakartaSansRegular)),
                    ),
                  );
                }
