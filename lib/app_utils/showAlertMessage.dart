    ...
    showDialog(
        ...
        builder: (BuildContext context) => Theme(
            ...
            child: CupertinoAlertDialog(
              title: const Text(
                AppStrings.appTitle,style: TextStyle(color: purpleGradientColor,fontWeight: FontWeight.bold),
              ),
              content: Text(
                "\n" + message + "\n",
                ...
                CupertinoDialogAction(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(5),color: purpleGradientColor
                      ),
                      child: const Align(
  ...
  showErrorAlertLogin(context, message) {
    showDialog(
        ...
        builder: (BuildContext context) => Theme(
            ...
            child: CupertinoAlertDialog(
              title: const Text(
                AppStrings.appTitle,style: TextStyle(color: blueColor,fontWeight: FontWeight.bold),
              ),
              content: Text(
                "\n" + message + "\n",
